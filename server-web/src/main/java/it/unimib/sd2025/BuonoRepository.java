...
public class BuonoRepository extends DatabaseConnection {
    ...
    public String createBuono(String id, double valore, String tipologia, String dataCreazione, String dataConsumo) throws IOException {
        if (id == null || id.isEmpty() || tipologia == null || tipologia.isEmpty() || dataCreazione == null || dataCreazione.isEmpty()) {
